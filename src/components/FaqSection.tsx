...
const faqs = [
  ...
  },
  {
    ...
    a: "We have the quickest turnaround times depending on complexity, feedback cycles, and final deliverable formats. Some projects can be done within 24 hours.",
  },
];
